" Language:     Verilog HDL/SystemVerilog HDVL indent file
" Maintainer:	Mingzhi Li <limingzhi05@mail.nankai.edu.cn>
" Last Change:	2007-12-12 21:36:06 CST
"
" Buffer Variables:
...
setlocal indentkeys=!^F,o,O,0),0},=begin,=end,=fork,=join,=endcase,=join_any,=join_none
...
function GetVerilog_SystemVerilogIndent()
  ...
  if (indent2 != 1) && (last_line !~ '^\s*end\|\<begin\>') &&
        \ (curr_line =~ ')\s*;\s*$') && 
